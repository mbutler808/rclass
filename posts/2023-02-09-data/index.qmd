...
=======
title: Types of Data
>>>>>>> d79fc3c365b62d8b99ce43d18c855f98c43ad31a
author:
...
For example, `large` and `small`, or `blue`, `red`, and `yellow`. Factors may be ordered, which means that the order of the categories has meaning (like income categories). By default, factors are unordered. Levels are the values (i.e., names of the categories) that the factor can take.

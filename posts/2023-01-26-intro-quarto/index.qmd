...
-   [TinyTex] If you want to render to .pdf, and you donʻt want to use RStudio, you will ahve to install TinyTex so that pandoc can find it. At the command line: `quarto install tinytex`
